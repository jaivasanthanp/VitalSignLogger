...
#define AI_NETWORK_MODEL_SIGNATURE     "0x57d7e16e828d9eda8c3d2fad870d9286"
...
#define AI_TOOLS_DATE_TIME   "2026-03-20T02:06:47+0100"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  10, 0x0,
  AI_SHAPE_INIT(4, 19, 32, 1, 1), AI_STRIDE_INIT(4, 4, 76, 2432, 2432),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 4876, 1, 1),
    4876, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 204, 1, 1),
    204, NULL, NULL),
  ...
  &dense_dense_layer, 0xab547463, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    dense_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 76);
    dense_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 76);
    dense_output_array.data = AI_PTR(g_network_activations_map[0] + 76);
    dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 76);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 2432);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 2432);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 2560);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 2560);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 4608);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 4608);
    dense_2_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 4672);
    dense_2_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 4672);
    dense_2_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 4864);
    dense_2_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 4864);
    return true;
  }
